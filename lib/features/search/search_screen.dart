...
class SearchScreen extends GetView<SearchController> {
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Search History or Filters
            Expanded(
              child: Obx(() {
                if (controller.showSearchHistory.value && controller.searchHistory.isNotEmpty) {
                  return _buildSearchHistory();
                }
                return _buildFiltersContent();
              }),
            ),
          ],
        ),
  ...
  /// Builds the search history widget
  ...
  /// Builds the filters content widget
